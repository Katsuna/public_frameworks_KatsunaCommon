...
public abstract class ContactsGroupAdapterBase extends RecyclerView.Adapter<RecyclerView.ViewHolder>
        implements Filterable {

    protected static final int NO_CONTACT_POSITION = -1;
    private final ContactFilter mFilter = new ContactFilter();
    protected List<ContactsGroup> mOriginalContacts;
    protected List<ContactsGroup> mFilteredContacts;
